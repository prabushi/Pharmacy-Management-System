/*
 * The class to represent the bottompanel with switch user and logout buttonin admin dashboard
 */
package AdminGUI;
 ...
 * @author Prabushi
 */
//have used singleton design pattern to implement the panel
public class BottomPanel extends JPanel {
    ...
    public BottomPanel() {
        ...
        switchUser.setText("User View");
        switchUser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/adminbottom1.jpg")));
        ...
        switchUser.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void switchUserActionPerformed(ActionEvent evt) {
                AdminPage.getInstance().setVisible(false);
                java.awt.EventQueue.invokeLater(new Runnable() {
                    public void run() {
                        JFrame frame = Page.getInstance();
        ...
        logout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/adminbottom2.jpg")));
