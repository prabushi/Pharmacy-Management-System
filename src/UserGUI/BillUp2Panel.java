/*
 JPanel to bill items according to the quntity going to buy
 */
package UserGUI;
 ...
 * @author Prabushi
 */
public class BillUp2Panel extends JPanel {

    public static BillUp2Panel instance = null;
    private JButton add;
    ...
    private BillUp2Panel() {
        ...
        try {
            ...
            if (rs1.next()) {
                ...
                Bquantity.setText("0");
                String q = Bquantity.getText();
                Float t = Integer.parseInt(q) * Tprice;
        ...
        Bquantity.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void BquantityYActionPerformed(ActionEvent evt) {
                ...
                Btotal.setText(Float.toString(tot));
            }
        });
    ...
    public static BillUp2Panel getInstance() {
        if (instance == null) {
            instance = new BillUp2Panel();
        }
        return instance;
    }
}
