/*
 * To display the details of salesmen
 */
 ...
 * @author Prabushi
 */
public class Other3 extends JPanel {

    LinkedList<Object> salesmen = new LinkedList<Object>();
    DefaultTableModel model;
    JTable table;
    String[][] data = new String[salesmen.size()][5];
    String[] columnNames = {"Name", "Phone No.", "Company", "Created At", "Removed At"};
    public static Other3 instance = null;
    ...
    public Other3() {
        ...
        String sql = "select * from salesmen,company where salesmen.CompanyId = company.CompanyId";
        try {
            ...
            while (rs4.next()) {
                ...
                String address = rs4.getString("CompanyName");
        ...
        data = new String[salesmen.size()][5];
        this.setTable();
    ...
    //the details of salemen are set to the table
    public void setTable() {

        if (!salesmen.isEmpty()) {

            for (int i = 0; i < salesmen.size(); i++) {
                Object item = salesmen.get(i);
    ...
    public static Other3 getInstance() {
        if (instance == null) {
            instance = new Other3();
        }
        return instance;
