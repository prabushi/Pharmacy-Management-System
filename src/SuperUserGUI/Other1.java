/*
 * To display the details of customers
 */
 ...
 * @author Prabushi
 */
public class Other1 extends JPanel {

    LinkedList<Object> customer = new LinkedList<Object>();
    DefaultTableModel model;
    JTable table;
    String[][] data = new String[customer.size()][5];
    String[] columnNames = {"Name", "Phone No.", "Address", "Created At", "Removed At"};
    public static Other1 instance = null;
    ...
    public Other1() {
        ...
        try {
            ...
            while (rs4.next()) {
                ...
                String phone = rs4.getString("PhoneNum");
        ...
        data = new String[customer.size()][5];
        this.setTable();
    ...
    //set the table content according to the list of customers
    public void setTable() {
        if (!customer.isEmpty()) {

            for (int i = 0; i < customer.size(); i++) {
                Object item = customer.get(i);
    ...
    public static Other1 getInstance() {
        if (instance == null) {
            instance = new Other1();
        }
        return instance;
