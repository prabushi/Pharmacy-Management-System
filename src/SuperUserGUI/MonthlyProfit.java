/*
 * The class to represent the profit of each month in this year
 */
 ...
 * @author Prabushi
 */
public class MonthlyProfit extends JPanel {

    float[] revenue = new float[12];
    public static MonthlyProfit instance = null;
    JLabel Ltotal;
    JTextField total;
    JButton export;
    int month;
    ...
    public MonthlyProfit() {
        ...
        try {
            ...
            for (int i = 0; i < 12; i++) {
                tot += revenue[i];
                barChartData.setValue(revenue[i], "Total Profit", monthName[i]);
            }
            total.setText(Float.toString(tot));
            JFreeChart barChart = ChartFactory.createBarChart("Monthly Profit", "Month", "Profit(Rs.)", barChartData, PlotOrientation.HORIZONTAL, false, false, false);
            ...
            export.addActionListener(new java.awt.event.ActionListener() {
                ...
                private void oneActionPerformed(ActionEvent evt) {
                    ...
                    content+="\n"+"\n"+"Annual Profit : "+total.getText();
                    
                    writeToFile(content, Integer.toString(year) + "_Profit.doc");
                }
            });
    ...
    public static MonthlyProfit getInstance() {
        if (instance == null) {
            instance = new MonthlyProfit();
        }
        return instance;
    }
}
