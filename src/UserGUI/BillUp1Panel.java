 ...
 * @author Prabushi
 */
public class BillUp1Panel extends JPanel {

    public static BillUp1Panel instance = null;
    private JButton add;
    ...
    private BillUp1Panel() {
        ...
        String[] turnset = {"QDS(6 hourly)", "TDS(8 hourly)", "BD(12 hourly)", "NOCTE(Night)", "MARNE(Morning)"};
        ...
        turn.setPreferredSize(new Dimension(110, 25));
        JLabel days = new JLabel("Day :");
        days.setPreferredSize(new Dimension(110, 25));
        ...
        Bquantity.setPreferredSize(new java.awt.Dimension(220, 25));
        ...
        Bturn = new JComboBox();
        Bturn.setPreferredSize(new java.awt.Dimension(220, 25));
        Bdays = new JComboBox();
        Bdays.setPreferredSize(new java.awt.Dimension(220, 25));
        ...
        gc.gridy = 10;
        add(Bturn, gc);
        Bturn.setModel(new javax.swing.DefaultComboBoxModel(turnset));
        Bturn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BturnActionPerformed(evt);
            }

            private void BturnActionPerformed(ActionEvent evt) {
                Bquantity.setText("0");
                Btotal.setText("0");
                String tu = (String) Bturn.getSelectedItem();
                int times = getTurn(tu);
                int d = Integer.parseInt((String) Bdays.getSelectedItem());
                int amount = times * d;
                String quant = String.valueOf(amount);
                String price = Bprice.getText();
                float Tprice = Float.parseFloat(price);
                Bquantity.setText(quant);
                float t = amount * Tprice;
                Btotal.setText(Float.toString(t));
            }
        });
        ...
        gc.gridy = 10;
        add(Bdays, gc);
        Bdays.setModel(new javax.swing.DefaultComboBoxModel(day));
        Bdays.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BdaysActionPerformed(evt);
            }

            private void BdaysActionPerformed(ActionEvent evt) {
                Bquantity.setText("0");
                Btotal.setText("0");
                String tu = (String) Bturn.getSelectedItem();
                int times = getTurn(tu);
        ...
        Bquantity.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BquantityYActionPerformed(evt);
            }

            private void BquantityYActionPerformed(ActionEvent evt) {
            }
        });
        ...
        add.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void addActionPerformed(ActionEvent evt) {
                String tempQuan = Bquantity.getText();
                int tempquan = Integer.parseInt(tempQuan);
        ...
        delete.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void clearActionPerformed(ActionEvent evt) {
                ...
                String tempName = (String) Bname.getSelectedItem();
                String tempTotal = (String) Btotal.getText();
    ...
    //return how many times a day 
    public int getTurn(String x) {
        switch (x) {
            case "QDS(6 hourly)":
                return 4;
            case "TDS(8 hourly)":
    ...
    public static BillUp1Panel getInstance() {
        if (instance == null) {
            instance = new BillUp1Panel();
        }
        return instance;
    }
}
